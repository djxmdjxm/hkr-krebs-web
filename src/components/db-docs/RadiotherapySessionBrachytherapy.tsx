export default function RadiotherapySessionBrachytherapyDoc() {
  return (
    <section className="max-w-5xl w-full mx-auto p-6 bg-white rounded-3xl shadow-sm mb-12">
      <h2 className="text-3xl font-bold mb-6">
        🌟 Brachytherapie — Sitzung <code className="font-mono text-xl text-gray-500 ml-2">(radiotherapy_session_brachytherapy)</code>
      </h2>
      ...
      <table className="min-w-full text-sm text-left border border-gray-300 rounded-lg overflow-hidden">
        ...
        <tbody className="divide-y divide-gray-200">
          ...
          <TableRow
            field="type"
            type="Enum"
            description="Type of brachytherapy / Typ der Brachytherapie"
            enumValues={[
              ["I", "Interstitial / Interstitiell"],
              ["K", "Cavitary / Endokavitär"],
            ]}
          />
          ...
          <TableRow
            field="dose_rate"
            type="Enum"
            description="Dose rate type / Dosisleistungsart"
            enumValues={[
              ["HDR", "High Dose Rate / Hochdosisleistung"],
              ["LDR", "Low Dose Rate / Niedrigdosisleistung"],
              ["PDR", "Pulsed Dose Rate / Gepulste Dosisleistung"],
            ]}
          />
