export default function RadiotherapySessionPercutaneousDoc() {
  return (
    <section className="max-w-5xl w-full mx-auto p-6 bg-white rounded-3xl shadow-sm mb-12">
      <h2 className="text-3xl font-bold mb-6">
        💡 Radiotherapy Session (Percutaneous)
      </h2>
      ...
      <table className="min-w-full text-sm text-left border border-gray-300 rounded-lg overflow-hidden">
        ...
        <tbody className="divide-y divide-gray-200">
          <TableRow
            ...
            type="Integer (FK)"
            description="Reference to general radiotherapy session / Verweis auf Bestrahlungssitzung"
          />

          <TableRow
            field="chemoradio"
            type="Enum"
            description="Chemoradiotherapy / Radiochemo"
            enumValues={[
              ["RCN", "Without chemotherapy / Ohne Chemotherapie"],
              ["RCJ", "With chemotherapy / Mit Chemotherapie"],
            ]}
          />
          ...
          <TableRow
            field="stereotactic"
            type="Boolean"
            description="Stereotactic treatment / Stereotaktische Behandlung"
          />

          <TableRow
            field="respiratory_gated"
            type="Boolean"
            description="Respiratory gated / Atemgetriggerte Behandlung"
          />
